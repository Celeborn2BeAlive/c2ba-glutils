...
public:
    ...
    GLuint2 getSize() const {
        return GLuint2(getWidth(), getHeight());
    }
...
public:
    ...
    bool init(const GLuint2& size, const GLenum internalFormats[NbColorBuffers],
              GLenum depthInternalFormat, GLenum filter = GL_NEAREST) {
    ...
    bool init(const GLuint2& size, const std::array<GLenum, NbColorBuffers>& internalFormats,
              GLenum depthInternalFormat, GLenum filter = GL_NEAREST) {
        return init(size.x, size.y, internalFormats, depthInternalFormat, filter);
    }
...
public:
    ...
    bool init(const GLuint2& size, const GLenum internalFormats[NbColorBuffers], GLenum filter = GL_NEAREST) {
    ...
    bool init(const GLuint2& size, const std::array<GLenum, NbColorBuffers>& internalFormats, GLenum filter = GL_NEAREST) {
        return init(size.x, size.y, internalFormats, filter);
    }
